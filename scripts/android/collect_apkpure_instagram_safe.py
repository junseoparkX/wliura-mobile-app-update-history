...
APP_NAME = "Instagram"
PLATFORM = "Android"
DEVELOPER_COMPANY = "Instagram"
APP_CATEGORY = "Social"

# Official Android release date from Instagram announcement/history references.
INITIAL_APP_RELEASE_DATE = "April 3, 2012"

PACKAGE_NAME_FALLBACK = "com.instagram.android"

VERSIONS_URL = "https://apkpure.com/instagram-android-2025/com.instagram.android/versions"
BASE_URL = "https://apkpure.com"
FALLBACK_DETAIL_BASE_URL = "https://apkpure.com/instagram-android-2025/com.instagram.android/download/"

# If this script is in:
# project/code/collect_apkpure_instagram_safe.py
# then data will be saved to:
# project/data/raw/android/...
SCRIPT_DIR = Path(__file__).resolve().parent
PROJECT_DIR = SCRIPT_DIR.parent.parent
DEFAULT_OUTPUT = PROJECT_DIR / "data" / "raw" / "android" / "instagram_apkpure_versions_enriched.csv"
...
# Instagram APKPure rows can look like:
# Instagram 428.0.0.47.67 / Latest / XAPK / 123.0 MB / May 5, 2026 / Download
# Instagram 428.0.0.41.67 / APK / 125.2 MB / May 4, 2026 / Download
...
WHATS_NEW_RE = re.compile(
    ...
    r"(?P<desc>.*?)"
    r"(?=Download\s+(?:APK|XAPK|APKS)|\d+\s*/\s*\d+|Scan Result|Old Versions of Instagram|Instagram Screenshots|All Versions|Featured Reviews|Related Tags|APKPure)",
    re.IGNORECASE | re.DOTALL,
)
...
def parse_more_app_info(lines):
    """
    Parses Instagram Additional APP Information fields:
    Latest Version
    428.0.0.47.67
    Uploaded by
    TikTok Pte. Ltd.
    ...
    APKPure may not show Package Name or App Permissions on every Instagram detail page,
...
def remove_apkpure_boilerplate(desc: str, version: str) -> str:
    ...
    boilerplate_patterns = [
        rf"{APP_NAME} is a social networking app that helps you share moments and connect with people\.?",
        rf"Download and install old versions of {APP_NAME} that suits your device model and enjoy your favorite features!?",
        rf"{APP_NAME} old version {re.escape(version)} was released on .*? by Instagram\. ?",
        ...
        r"Check out the detailed comparison between the latest and old version of Instagram.*",
    ]
...
def main():
    ...
    parser.add_argument(
        "--detail-text-dir",
        default=None,
        help="Optional folder containing browser-copied detail pages named like 428.0.0.47.67.txt.",
    )
