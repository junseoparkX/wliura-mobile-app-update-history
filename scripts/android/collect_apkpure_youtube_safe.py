...
APP_CATEGORY = "Video Players & Editors"
...
PACKAGE_NAME_FALLBACK = "com.google.android.youtube"

VERSIONS_URL = "https://apkpure.com/youtube-2025/com.google.android.youtube/versions"
BASE_URL = "https://apkpure.com"
FALLBACK_DETAIL_BASE_URL = "https://apkpure.com/youtube-2025/com.google.android.youtube/download/"

# If this script is in:
# project/code/collect_apkpure_youtube_safe.py
# then data will be saved to:
# project/data/raw/android/...
SCRIPT_DIR = Path(__file__).resolve().parent
PROJECT_DIR = SCRIPT_DIR.parent.parent
DEFAULT_OUTPUT = PROJECT_DIR / "data" / "raw" / "android" / "youtube_apkpure_versions_enriched.csv"
...
# YouTube APKPure rows can look like:
# YouTube 21.18.164 / APK / 177.6 MB / May 5, 2026 / Download
# YouTube 21.17.481 / APK / 177.5 MB / Apr 30, 2026 / Download
...
WHATS_NEW_RE = re.compile(
    ...
    r"(?P<desc>.*?)"
    r"(?=Download\s+(?:APK|XAPK|APKS)|\d+\s*/\s*\d+|Scan Result|Old Versions of YouTube|YouTube Screenshots|All Versions|Featured Reviews|Related Tags|APKPure)",
    re.IGNORECASE | re.DOTALL,
)
...
def parse_more_app_info(lines):
    """
    Parses YouTube Additional APP Information fields:
    Latest Version
    428.0.0.47.67
    Uploaded by
    Google LLC
    ...
    APKPure may not show Package Name or App Permissions on every YouTube detail page,
...
def remove_apkpure_boilerplate(desc: str, version: str) -> str:
    ...
    boilerplate_patterns = [
        rf"{APP_NAME} is a video streaming app that helps you watch, create, and share videos across many topics\.?",
        ...
        r"Check out the detailed comparison between the latest and old version of YouTube.*",
    ]
...
def main():
    ...
    parser.add_argument(
        "--detail-text-dir",
        default=None,
        help="Optional folder containing browser-copied detail pages named like 21.18.164.txt.",
    )
