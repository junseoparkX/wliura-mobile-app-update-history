...
# Google Docs launched on the web in October 2006; the dedicated Android app was released in April 2012.
INITIAL_APP_RELEASE_DATE = "April 2012"

PACKAGE_NAME_FALLBACK = "com.google.android.apps.docs.editors.docs"

VERSIONS_URL = "https://apkpure.com/google-docs/com.google.android.apps.docs.editors.docs/versions"
BASE_URL = "https://apkpure.com"
FALLBACK_DETAIL_BASE_URL = "https://apkpure.com/google-docs/com.google.android.apps.docs.editors.docs/download/"

# If this script is in:
# project/code/collect_apkpure_google_docs_safe.py
# then data will be saved to:
# project/data/raw/android/...
SCRIPT_DIR = Path(__file__).resolve().parent
PROJECT_DIR = SCRIPT_DIR.parent.parent
DEFAULT_OUTPUT = PROJECT_DIR / "data" / "raw" / "android" / "google_docs_apkpure_versions_enriched.csv"
...
# Google Docs APKPure rows can look like:
# Google Docs 1.26.161.04.90 / 116.2 MB / May 5, 2026 / Download
# Google Docs 1.26.161.02.90 / XAPK / 83.0 MB / Apr 28, 2026 / Download
...
WHATS_NEW_RE = re.compile(
    ...
    r"(?P<desc>.*?)"
    r"(?=Download\s+(?:APK|XAPK|APKS)|\d+\s*/\s*\d+|Scan Result|Old Versions of Google Docs|Google Docs Screenshots|All Versions|Featured Reviews|Related Tags|APKPure)",
    re.IGNORECASE | re.DOTALL,
)
...
def parse_more_app_info(lines):
    """
    Parses Google Docs Additional APP Information fields:
    Latest Version
    428.0.0.47.67
    Uploaded by
    ...
    APKPure may not show Package Name or App Permissions on every Google Docs detail page,
...
def remove_apkpure_boilerplate(desc: str, version: str) -> str:
    ...
    boilerplate_patterns = [
        rf"{APP_NAME} is a cloud-based word processor app that lets you create and collaborate on documents\.?",
        ...
        r"Check out the detailed comparison between the latest and old version of Google Docs.*",
    ]
...
def is_generic_description(raw_desc: str, clean_desc: str) -> bool:
    ...
    generic_phrases = [
        "cloud-based word processor app",
        "word processor app",
        "productivity app",
